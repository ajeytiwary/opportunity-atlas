...
from .adapters_public import PUBLIC_ADAPTERS
...
def kaggle_competitions(search:str='',page:int=1):
 ...
 return out
ADAPTERS={'grants_gov':grants_gov,'eu_funding_tenders':eu_funding_tenders,'kaggle':kaggle_competitions,**EXTRA_ADAPTERS,**PUBLIC_ADAPTERS}
